...
namespace filmArsivim
{
    public partial class FormElestiriler : Form
    {
        ...
        void VeriGetir()
        {
            ...
            {
                baglanti.Open();
                string sorgu = "SELECT filmler.film_ad, elestiriler.elestiri_metin, elestiriler.elestiri_metin,elestiriler.puan,elestiriler.elestiri_tarihi,elestiriler.elestirmen FROM elestiriler JOIN filmler ON filmler.film_id=elestiriler.elestiri_id;";
